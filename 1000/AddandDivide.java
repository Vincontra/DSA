...
public class AddandDivide{
    ...
    static void solve() {
        ...
        if (b>a){
            ...
            long ans=1+steps(a,b+1);
            //  b+=1;  // now b is 2 so it takes 1 step to convert b from 1 to 2
            for (int j=2;j<=6;j++){   // from b=3 onwards we are doing iterations
                long step=j+steps(a,j+b);
    ...
    public static long steps(long a,long b){
        int cnt=0;
        while (a>0){
            a=a/b;
            cnt++;
