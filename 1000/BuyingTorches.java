...
//        long y=fr.nextLong();
//        long k=fr.nextLong();
//        System.out.println((long)Math.ceil(y*k+(k-1))/(x-1)+k);
//
//
//    }
    static void solve() {
        ...
        long y=fr.nextLong();
        long k=fr.nextLong();
        //System.out.println((long)Math.ceil(y*k+(k-1))/(x-1)+k);  ye sahi hai lekin isme proper bodmas not followed is liye ans
        // galat arah tha
        // Math.ceil(x/y) is same as   (x+y-1)/y  so bas waise hi kara hai

        // kabhi kabhi dil me khayal ata hai
        // ke mere dil me tuze basa lu..
        // dil jo haseen khwab likh kr baitha hai
        // lekin usse tum se bol na saku...@vpg

        long num=y*k+(k-1);
        long den=x-1;
        long ans=(num+den-1)/den;
