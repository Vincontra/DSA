...
public class HelmetsNightLight{
    ...
    static void solve() {
        ...
        for (int i=0;i<n;i++){
            l1.add(new Pair(arr[i],brr[i]));
        }

        l1.sort((p1, p2) -> Long.compare(p1.cost, p2.cost));

//        long ans=0;
//        int rem=n;
//
//        if (l1.get(0).cost*l1.get(0).mens<p*l1.get(0).mens){
//            ans+=p;
//            rem--;
//        }
//        else{
...
//        int index=0;
//        while (rem>0){
//            ans+=l1.get(index).mens*l1.get(index).cost;
//            rem-=l1.get(index).mens;
//            index++;
//        }
        ...
        for (Pair P:l1){
            if (rem>0){
                ...
                ans+=(long)P.cost*((long)Math.min((long)P.mens,(long)rem));
                rem-=(long)Math.min(P.mens,rem);
            }
            else{
                break;
            }
