...
public class MakeEqualAgain{
    ...
    static void solve() {
        ...
        int maxFreqFromLeft=1;
        int maxFreqFromRight=1;
        for (int i=0;i<n-1;i++){
            if (arr[i]==arr[i+1]){
                maxFreqFromLeft++;
            }else{
...
//        if (maxFreqFromLeft==0){
//            maxFreqFromLeft=1;
//        }
        if (maxFreqFromLeft==n){
            out.println(0);
            return;
        }
        for (int i=n-1;i>0;i--){
...
//        if (maxFreqFromRight==0){
//            maxFreqFromRight=1;
//        }

        if (arr[0]==arr[n-1]){
            out.println(n-(maxFreqFromLeft+maxFreqFromRight));
        }
        else{
            out.println(n-Math.max(maxFreqFromLeft,maxFreqFromRight));
        }
    }
