...
public class MonocarpString{
    ...
    static void solve() {
        ...
        if (cntA==cntB){
           ...
           int k=cntA-cntB;  // now we need to find this many number of 'a' must be there in the string contigues to remove if not return -1
            // k length ki window chalani padegi
            if (k==n){
                out.println(-1);
                return;
            }
