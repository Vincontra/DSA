...
public class PlusMinusPermutation{
    ...
    // ---------- Solve ----------
    static void solve() {
 // we are finding the lcm just to count the common numbers as ultimately they are going to be cancel so there is no point to add them and again subtract them
        long n = fr.nextLong();
        long x = fr.nextLong();
        long y = fr.nextLong();
        long n1 = n / x;
        ...
        n1 -= cnt;
        n2 -= cnt;
// sum of AP (decreasing from n, d = -1, terms = n1)
        long sn1 = n1 * (2 * n + (n1 - 1) * -1) / 2;
// sum of AP (increasing from 1, d = 1, terms = n2)
        long sn2 = n2 * (2 + (n2 - 1)) / 2;
        out.println(sn1 - sn2);
    }
