...
public class Forked{
    ...
    static void solve() {
        ...
        long xq=fr.nextLong();
        long yq=fr.nextLong();
        ArrayList<Points>king=new ArrayList<>();
        ArrayList<Points>queen=new ArrayList<>();

        if (a==b){
            // in this case only 4 points for king and quenn each will be there
            king.add(new Points(xk-b,yk+a));
            king.add(new Points(xk+b,yk+a));
            king.add(new Points(xk-b,yk-a));
            king.add(new Points(xk+b,yk-a));

            queen.add(new Points(xq-b,yq+a));
            queen.add(new Points(xq+b,yq+a));
            queen.add(new Points(xq-b,yq-a));
            queen.add(new Points(xq+b,yq-a));
            ...
            // in this case 8 points will be there
...
//  ------------------------------------------------------- //
            ...
            queen.add(new Points(xq-a,yq+b));
            queen.add(new Points(xq-a,yq-b));
            queen.add(new Points(xq+a,yq+b));
            queen.add(new Points(xq+a,yq-b));
