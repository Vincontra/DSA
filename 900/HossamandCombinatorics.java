...
public class HossamandCombinatorics{
    ...
    static void solve() {
        ...
        if (max==min){ // only possible when all elements are same say 2 2 2
            // so agar if we count it would be like 1*2*2+1*1*2=6 which is n*(n-1)
        ...
        System.out.println(2L*cntmax*cntmin);
    }
