...
public class MexMaster{
    ...
    static void solve() {
        ...
        int arr[]=new int[n];
        int cntZ=0;
         boolean check=false; // when there exist even a single number greater than 1 so that what happeen is we can have mex as 1 then
        // eg 00000000000x11111111
        // in this case sum will be never equal to 1 so mex would be 1 and that is our answer
        for (int i=0;i<n;i++){
            arr[i]=fr.nextInt();
            if (arr[i]>=2){
                check=true;
