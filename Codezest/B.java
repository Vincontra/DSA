...
//           long brr[]=func(m,MOD);
//           if (n==m){
//               System.out.println((arr[(int)n]*brr[(int)m]*2)%MOD);
//           }else{
//               System.out.println((arr[(int)n]*brr[(int)m])%MOD);
//           }
//       }
//       else{
//           System.out.println(0);
//          // System.out.println("cdhbibc");
//       }
//
//
////       if(n>m){
...
//
//    }
//    public static long[] func(long n,int mod){
