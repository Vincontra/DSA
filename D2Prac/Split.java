...
public class Split{
    ...
    static void solve() {
        ...
        int z=0;
        // x+2y+2z
        // x means cnt of odd who has odd freq
        // y means count of freq like 4k+2 (2,6,10...)
        // z means cnt of form 4k
//        x+2y+2z, if x>0 or z is even,
//        x+2y+2z−2,if x=0 and z is odd.
...
//
        ...
        ans=x+2*y+2*z;
        if (x==0&&z%2==1){
            ans=ans-2;  /// full potentila we can never reach so -2
        }
        out.println(ans);
    }
