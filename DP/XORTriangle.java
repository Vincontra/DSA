...
public class XORTriangle{
    ...
    static void solve() {
        ...
        // x me jo 1st set bit hai usko y me bhi set
        // x me jo pehli zero bit hai usko bhi set
        long x1=x;
        long x2=x;
        int indZ=0;
        int indOne=0;
...
//    Think about the triangle inequalities for sides:
//
//        𝑥
//        ,
//        𝑦
...
//
//        👉 Meaning:
//        x and y must share at least one common set bit.
//
//        Hint 2
//
...
//        y+(x⊕y)>x
//
//        After simplifying using XOR properties, it implies:
//
//        👉 y must also have at least one bit that x does NOT have.
//
//        So:
//
//        One bit common with x
//
//        One bit different from x
//
//        Hint 3
//
//        So y must:
//
//        share at least one 1-bit with x
//
//        have at least one 1-bit where x has 0
//
//        This means:
//
//        y is made from one set bit of x + one unset bit of x
//
//        Hint 4
//
//        Edge cases where answer = −1
//
//        x is power of 2
//
//        Example:
...
//        x = 8 (1000)
//
//        Any y < x cannot share a bit with x → triangle fails.
//
//        x = 2^k − 1 (all bits 1)
//
//        Example:
...
//        x = 7 (111)
//
//        y cannot introduce a new bit without exceeding x.
//
//        ✅ Therefore solution exists only if x is neither:
//
//        a power of two
//
//        nor all bits = 1
//
//        Hint 5 (constructing y)
//
//        Pick:
//
//        lowest set bit of x
//
//        lowest zero bit of x
