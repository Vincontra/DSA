...
public class YuuKoitoMinimumAbsoluteSum{
    // ---------- Constants ----------
    ...
    static void solve() {
        ...
        // if there are -1 in between simply put 0 there and if there is only one -1 at start or end then calculate it
        // otherwise put 0 at start and end as well
        int cnt=0;
        for (int i=0;i<n;i++){
            if (i==0||i==n-1){
                if (arr[i]==-1){
