...
public class UsainTiger{
    ...
    // ---------- Solve ----------
    static void solve() {
        int finish = fr.nextInt();
        int disBolt = fr.nextInt();
        int tigerAcc = fr.nextInt();
        int boltSpeed = fr.nextInt();

        long lhs = 2L * (finish + disBolt) * boltSpeed * boltSpeed;  // Tiger
        long rhs = 1L * finish * finish * tigerAcc;                 // Bolt
